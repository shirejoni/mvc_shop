...
$config['resourceTypes'][] = array(
    ...
    'directory'         => 'js',
    'maxSize'           => 0,
    'allowedExtensions' => 'svg,ttf,woff,otf,woff2,eot,7z,aiff,asf,avi,bmp,csv,doc,docx,flv,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tar,tgz,tif,tiff,txt,vsd,wav,wma,wmv,xls,xlsx,zip,css,js',
    'deniedExtensions'  => '',
    'backend'           => 'default'
);
$config['resourceTypes'][] = array(
